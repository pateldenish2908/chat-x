...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0f1115] text-[#e2e8f0] p-6">
      ...
      <div className="mb-10 flex items-center gap-3">
        ...
        <h1 className="text-4xl font-bold drop-shadow text-white">ChatX</h1>
      </div>

      {/* Catchy Heading */}
      <h2 className="text-2xl sm:text-4xl font-semibold text-center mb-4 drop-shadow-lg text-white">
        Connect. Chat. Explore.
      </h2>

      {/* Sub Text */}
      <p className="text-center text-lg max-w-md mb-10 opacity-80 text-gray-400">
        Welcome to <span className="font-bold text-white">ChatX</span> – The easiest way to
      ...
      <Link
        href="/login"
        className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-lg hover:bg-blue-500 transition-all hover:scale-105"
      >
        Login
      </Link>

      {/* Decorative Illustration */}
      <div className="mt-16 w-64 h-64 opacity-20">
        <svg
          viewBox="0 0 512 512"
          fill="currentColor"
          xmlns="http://www.w3.org/2000/svg"
